...
import web.study.util.SpringBeanUtil;
...
public class SmsService  {
	...
	private static BaseConfig  base;
	
	static{
		base = SpringBeanUtil.getBean(BaseConfig.class);
		profile = DefaultProfile.getProfile("cn-hangzhou", base.smsAccessKeyId,
